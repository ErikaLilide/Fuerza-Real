...
function of_recognized_background_repeat() {
	...
	$default = array(
		'no-repeat' => __( 'No Repeat', 'crossfit-gym-pro' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'crossfit-gym-pro' ),
		'repeat-y'  => __( 'Repeat Vertically', 'crossfit-gym-pro' ),
		'repeat'    => __( 'Repeat All', 'crossfit-gym-pro' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'crossfit-gym-pro' ),
		'top center'    => __( 'Top Center', 'crossfit-gym-pro' ),
		'top right'     => __( 'Top Right', 'crossfit-gym-pro' ),
		'center left'   => __( 'Middle Left', 'crossfit-gym-pro' ),
		'center center' => __( 'Middle Center', 'crossfit-gym-pro' ),
		'center right'  => __( 'Middle Right', 'crossfit-gym-pro' ),
		'bottom left'   => __( 'Bottom Left', 'crossfit-gym-pro' ),
		'bottom center' => __( 'Bottom Center', 'crossfit-gym-pro' ),
		'bottom right'  => __( 'Bottom Right', 'crossfit-gym-pro')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'crossfit-gym-pro' ),
		'fixed'  => __( 'Fixed in Place', 'crossfit-gym-pro')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'crossfit-gym-pro' ),
		'italic'      => __( 'Italic', 'crossfit-gym-pro' ),
		'bold'        => __( 'Bold', 'crossfit-gym-pro' ),
		'bold italic' => __( 'Bold Italic', 'crossfit-gym-pro' )
		);
